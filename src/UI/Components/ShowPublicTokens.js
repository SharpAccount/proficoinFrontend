    ...
    return (
        <Container className="bg-light rounded-1" >
            <Form onSubmit={showTokens}>
                <Form.Label>Введите адрес пользователя, у которого хотите посмотреть токены публичной фазы пользователя </Form.Label>
...
export default ShowPublicTokens;